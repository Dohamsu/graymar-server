...
export const LLM_STATUS = ['SKIPPED', 'PENDING', 'RUNNING', 'DONE', 'FAILED'] as const;
export type LlmStatus = (typeof LLM_STATUS)[number];

export const EVENT_KIND = [
  'BATTLE', 'DAMAGE', 'STATUS', 'LOOT', 'GOLD',
  'QUEST', 'NPC', 'MOVE', 'SYSTEM', 'UI',
] as const;
...
export const AI_PERSONALITY = ['AGGRESSIVE', 'TACTICAL', 'COWARDLY', 'BERSERK', 'SNIPER'] as const;
...
export const TONE_HINT = [
  'neutral', 'tense', 'calm', 'mysterious', 'triumph', 'danger',
] as const;
...
export const COMBAT_OUTCOME = ['ONGOING', 'VICTORY', 'DEFEAT', 'FLEE_SUCCESS'] as const;
