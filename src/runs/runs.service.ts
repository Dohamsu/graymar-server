        ...
        enterResult = {
          ...
          summary: {
            short: [
              ...
              `2단계(접근 이유): 왜 당신에게 왔는지 설명한다. 로넨의 대사: "${preset?.prologueHook ?? '부두에서 당신이 일하는 것을 봤소. 길드 안 사람은 아무도 믿을 수가 없어서… 외부 사람이 필요했소.'}" 이 대사를 자연스럽게 녹여 넣되, 길드 내부 인물은 믿을 수 없어서 외부인이 필요하다는 점을 강조한다.`,
            ...
            display: [
              ...
              '',
              `"${preset?.prologueHook ?? '부두에서 당신이 일하는 것을 봤소. 길드 안 사람은 아무도 믿을 수가 없어서… 외부 사람이 필요했소.'}" 로넨이 목소리를 한층 낮췄다. "장부가 사라졌소. 이틀 전 밤에 사무실을 털렸는데… 공물 내역만이 아니오. 뒷거래 기록이 전부 들어 있소."`,
              '',
              '당신의 눈이 좁아졌다.',
              '',
