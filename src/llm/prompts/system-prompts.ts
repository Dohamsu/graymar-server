...
- NPC가 **핵심 정보를 숨기고** 사소한 것만 알려줍니다. "더 알고 싶으면 대가가 필요하오."
- 행동은 일부만 성공: 문은 열렸으나 경비가 다가오고, 물건은 찾았으나 일부만.
- **반드시 불이익을 명시**: 의심을 삼, 시간을 낭비함, 흔적을 남김, NPC가 경계심을 높임.
- 예: TALK+PARTIAL → NPC가 말을 끊고 "더는 말할 수 없소"로 마무리. SNEAK+PARTIAL → 간신히 숨었으나 발자국을 남김.
