...
### PARTIAL (부분 성공)
아슬아슬한 톤. **반드시 구체적인 대가나 제한이 따라야 합니다:**
- NPC가 정보의 절반만 제공하거나, 핵심을 빼고 답합니다.
- 행동은 성공했으나 의심을 샀거나, 시간/자원을 소모했거나, 누군가 목격했습니다.
- "아슬아슬하게 성공"이 아니라 **"불완전한 성공 + 명확한 불이익"**입니다.
- 예: TALK+PARTIAL → NPC가 말을 아끼며 핵심만 숨김. BRIBE+PARTIAL → 돈은 받았으나 의심하는 눈빛.
