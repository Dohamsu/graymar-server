...
const REGISTER_ENDING_FIXES: Record<string, Array<[RegExp, string]>> = {
  HAOCHE: [
    ...
    [/해요/g, '하오'],
    [/군요/g, '구려'],
    // DeepSeek 잔존 위반 재실측 (2026-07-31, 잔존 39.7%) — 주류는 합쇼가 아니라
    // 하게체·반말 침투 (~라네/~다네/~더군/~겠나/~인가). 문장 종결 앵커 전제.
    [/십니까/g, '시오'],
    [/습니까/g, '소'],
    [/입니까/g, '이오'],
    [/라네/g, '라오'],
  ...
  HAPSYO: [
    ...
    [/세요/g, '십시오'],
    [/해요/g, '합니다'],
    // 반말 침투 교정 (2026-07-31 재실측 — "방이야"·"배었어"·"기다리고 있네")
    [/이야/g, '입니다'],
    [/거야/g, '겁니다'],
    [/었어/g, '었습니다'],
    [/았어/g, '았습니다'],
  ...
  HAEYO: [
    ...
    [/(?<!십)시오/g, '세요'],
    [/구려/g, '군요'],
    // 반말 침투 교정 (2026-07-31 재실측 — "돌아왔군"·"심상치 않은데"·"있었나")
    [/이야/g, '이에요'],
    [/었어/g, '었어요'],
    [/았어/g, '았어요'],
    [/겠어/g, '겠어요'],
