  ...
  [
    ...
    // ── THREATEN: 위협·압박·겁주기·추궁·심문 ──
    {
      keywords: [
        ...
        '검을 꺼내', '검을 뽑', '칼을 꺼내', '칼을 뽑', '칼을 들이', '칼을 겨누', '검을 겨누', '겨누', '노려', '경고', '엄포',
    ...
    {
      keywords: [
        '조사', '살펴', '살펴본', '탐색', '찾아', '찾아본', '찾는', '수색', '숨겨진 물',
        '뒤지', '뒤져', '뒤진', '파헤', '파헤치', '캐물', '캐내', '추적',
        '증거', '단서', '정체', '배후', '진상',
        '확인', '검사', '들여다', '열어본', '열어보',
    ...
    // ── REST: 휴식·회복 ──
    {
      keywords: [
        ...
        '휴식', '잠을 자', '잠을 청', '회복하', '회복한', '회복할',
        '체력을 회복', '기운을 회복',
        '눕겠', '눕자', '누워서 쉬', '앉아서 쉬겠', '앉아서 쉬자', '앉아서 쉬어', '앉아서 좀',
        '기운을', '체력을', '한숨 돌', '숨을 고르', '정비', '재정비',
        '몸을 추스', '기력', '쉬어',
      ],
      actionType: 'REST',
    },
    ...
    // ── MOVE_LOCATION: 장소 이동 + 복귀 의도 ──
    {
      keywords: [
        // 일반 이동 동사
        '이동', '향한다', '향하', '떠나', '나간다', '나가자', '나가겠', '밖으로 나', '벗어나', '자리를 뜨',
        '다른 곳', '다른 장소', '다른 데', '딴 곳', '딴 데',
        '옮겨', '옮긴', '빠져나', '빠진다', '빠져서', '퇴장',
    ...
    // ── TALK: 대화 (최하위 — 다른 매칭이 없을 때 fallback) ──
    {
      keywords: [
        '대화', '이야기', '안부', '인사', '수다', '잡담',
        '말을 건', '말을 걸', '말을 건네', '말 걸', '말 건',
        '말을 붙', '말 붙', '한마디', '목소리를 건',
        '대화를 걸', '대화를 건', '대화를 시도', '대화하',
        '이야기를 건', '이야기를 나', '이야기하', '이야기 나',
        '얘기하', '얘기를 나', '얘기',
        '안부를 묻', '안부를 물', '인사하', '인사를 건',
        '말동무', '수다를',
        '물어', '물어본', '물어보',
        '말해', '말하',
