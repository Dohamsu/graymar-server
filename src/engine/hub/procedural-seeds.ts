...
export const TRIGGERS: ProceduralSeed[] = [
  ...
  { id: 'TRG_CROWD', text: '군중이 모여들고 있다' },
  {
    id: 'TRG_PATROL',
    text: '경비대 순찰이 지나간다',
    locationIds: ['LOC_GUARD', 'LOC_MARKET'],
  },
  { id: 'TRG_ARGUMENT', text: '말다툼이 벌어지고 있다' },
  {
    id: 'TRG_DELIVERY',
    text: '누군가 짐을 나르고 있다',
    locationIds: ['LOC_HARBOR', 'LOC_MARKET'],
  },
  { id: 'TRG_FIRE', text: '연기 냄새가 난다', timePhases: ['NIGHT', 'DUSK'] },
  {
    id: 'TRG_DRUNK',
    text: '취한 사람이 비틀거린다',
    timePhases: ['NIGHT', 'DUSK'],
  },
...
export const SUBJECTS: ProceduralSeed[] = [
  ...
  { id: 'SUB_SAILOR', text: '선원', locationIds: ['LOC_HARBOR'] },
  {
    id: 'SUB_THIEF',
    text: '소매치기',
    locationIds: ['LOC_MARKET', 'LOC_SLUMS'],
  },
